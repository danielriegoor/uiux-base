...
| `npm run test:workspaces` | comportamento React e helpers |
| `npm run build` | packages e apps compilam |
| `npm run check:package` | tarballs publicos e instalacao em consumidor limpo |
...
- Suite local: 15 arquivos e 38 testes verdes.
- Empacotamento: dois tarballs instalados em consumidor temporario limpo.
